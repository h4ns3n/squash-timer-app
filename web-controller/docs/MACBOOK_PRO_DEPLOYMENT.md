...
- **Start service**: `launchctl load ~/Library/LaunchAgents/com.squashtimer.web.plist`
- **Stop service**: `launchctl unload ~/Library/LaunchAgents/com.squashtimer.web.plist`
- **Update**: `~/squash-timer-app/update-server.sh`
- **View logs**: `tail -f ~/squash-timer-app/web-controller/logs/stdout.log`
- **Access URL**: `http://macbook-ip:3000`

The MacBook Pro will now automatically start the web controller on boot and keep it running! 🎾
